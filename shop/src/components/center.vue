<template>
    <div class="center">
            ...
            <div class="list-block media-list">
                ...
                <div class="item-media"><img :src="imgheader" style='width: 4rem;margin: 0px 10px;'></div>
                    <div class="item-inner">
                        <div class="it  em-text" style="font-size: 24px;" v-html="shopname">个人中心用户名...</div>
        ...
        <div class="list-block margin-t-7 member-link">
            <ul>
                <router-link :to="{name:'sellerInfo'}" tag="li" class="item-content item-link">
                    <div class="item-media"><i class="icon icon-f7"></i></div>
                    <div class="item-inner">
                        <div class="item-title">商铺信息</div>
                    </div>
                </router-link>
...
export default {
    name: 'center',
        ...
        methods: {
            getData: function () {
                var self = this;
                myFn.ajax('get', {}, apiAddress.shop.myShopInfo, function(res) {
                    self.name = res.data.name;
                    self.imgheader = res.data.image;
