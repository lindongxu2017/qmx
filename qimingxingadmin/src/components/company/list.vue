	                ...
	                <div id="paper-top">
	                    <div class="col-sm-12">
	                        <h2 class="tittle-content-header">
	                            ...
	                            <span class="public-page-name">保险公司</span>
	                        </h2>
	                    </div>
	                </div>
	            </div>
	                                ...
	                                <div class="body-nest" id="Footable">
	                                    <div class="row" style="margin-bottom:13px">    
	                                        ...
	                                        <div class="col-md-1 col-sm-1">
	                                        	<button style="height: 35px;width: 120px;" type="button" class="btn btn-primary" @click="query_company"><span class="entypo-search"></span>&nbsp;&nbsp;查询</button>
	                                        </div>
	                                    ...
	                                    <table class="table-striped footable-res footable metro-blue" data-page-size="6">
	                                        ...
	                                        <tbody>
	                                            <tr v-for="(item, index) in orderlist">
	                                                ...
	                                                <td >
	                                                    <button v-if="jurisdiction.show_addAddEditButton" type="button" class="btn btn-primary" @click="companyEdit(item.id)"><span class="fontawesome-edit"></span>&nbsp;&nbsp;编辑</button>
	                                                    <button v-if="jurisdiction.show_delButton" type="button" class="btn btn-danger" @click="companyDel(item.id, index)"><span class="entypo-cancel-squared"></span>&nbsp;&nbsp;删除</button>
	                                                </td>
	                                            </tr>
...
export default {
	name: 'companylist',
		...
		mounted (){
			// 权限控制
            this.jurisdiction.show_addAddEditButton = myFn.getLocalStorageVal('jurisdiction', 43) ? true : false;
            this.jurisdiction.show_delButton = myFn.getLocalStorageVal('jurisdiction', 44) ? true : false;
